...
const sheetVariants = cva(
    "w-full fixed z-50 gap-4 bg-background  shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 overflow-y-auto",
    {
        variants: {
            side: {
...
const SheetHeader = ({
    ...
    <div
        className={cn(
            "flex  px-sp5 py-sp6 border-b border-gray-normal ",
            className,
        )}
        {...props}
    />
